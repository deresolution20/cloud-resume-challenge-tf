...
resource "aws_api_gateway_integration" "tf_integration" {
    ...
    uri = "arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-1:121505435355:function:tf_LambdaFunctionNameGoesHere/invocations"
}
